...
import 'package:farmcart/pages/seller/auth_pages/payment_page.dart';
                            ...
                            onPressed: () async {
                              ...
                              if (_formKey.currentState.validate()) {
                                ...
                                if (_userData['Success']) {
                                  ...
                                  if (_userData['payment_Status'] != null) {
                                    print('Payment Status is Not null');
                                    if (_userData['payment_Status'] ==
                                        'Success') {
                                      ...
                                      print('Payment status is failed');
                                      _authService.checkPaymentStatus(
                                          username, password);
                                      Navigator.push(
                                        context,
                                        MaterialPageRoute(
